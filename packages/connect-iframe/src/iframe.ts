...
const handleMessage = (event: PostMessageEvent) => {
    ...
    const message: CoreEvent = parseMessage(data);
...
const postMessage = (message: CoreEvent) => {
...
const targetUiEvent = (message: CoreEvent) => {
...
const filterDeviceEvent = (message: CoreEvent) => {
