...
// REF-TODO: imports
import { factory } from '@trezor/connect/lib/api/factory';
...
import type { ConnectSettings, Manifest, PostMessageEvent, UiResponse } from '@trezor/connect';
...
const uiResponse = (response: UiResponse) => {
    if (!iframe.instance) {
