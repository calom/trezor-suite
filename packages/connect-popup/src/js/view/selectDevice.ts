import { UiMessage, UI, POPUP, ERRORS } from '@trezor/connect';
...
import type { SelectDevice } from '@trezor/connect';
...
export const selectDevice = (payload: SelectDevice['payload']) => {
    if (!payload) return;
