...
import type { ButtonRequestMessage } from '@trezor/connect';
...
const showAddressValidation = (payload: ButtonRequestMessage['payload']) => {
...
export const requestButton = (payload: ButtonRequestMessage['payload']) => {
