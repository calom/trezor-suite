...
import bipWords from '@trezor/connect/lib/utils/bip39';

const initWordPlainView = (payload: ReturnType<typeof DeviceMessage>['payload']) => {
    showView('word-plain');
...
const initWordMatrixView = (payload: ReturnType<typeof DeviceMessage>['payload']) => {
...
export const initWordView = (payload: ReturnType<typeof DeviceMessage>['payload']) => {
