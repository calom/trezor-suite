...
export const showFirmwareUpdateNotification = (device: UnexpectedDeviceMode['payload']) => {
...
export const showBackupNotification = (_device: UnexpectedDeviceMode['payload']) => {
    const container = document.getElementsByClassName('notification')[0];
